    ...
    <header className="site-nav">
      ...
      <div className="nav-actions">
        <div className="nav-contact">
          <a href="tel:+38970842079" className="phone" aria-label={lang === "mk" ? "Јавете се на +389 70 842 079" : "Call +389 70 842 079"}>
          ...
          <span className="messaging-links">
            <a className="whatsapp-link" href="https://wa.me/38970842079" target="_blank" rel="noreferrer" aria-label={lang === "mk" ? "Пишете ни на WhatsApp" : "Message us on WhatsApp"} title="WhatsApp">
            ...
            <a className="viber-link" href="viber://chat?number=%2B38970842079" aria-label={lang === "mk" ? "Пишете ни на Viber" : "Message us on Viber"} title="Viber">
